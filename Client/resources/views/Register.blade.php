...
<head>
    <meta charset="utf-8">
    <title>DeathmatchZ Register</title>
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span4 offset4">
            <div class="signin">
                <h1 class="center-align-text">Client Registration</h1>
                <form action="{{ asset('/register') }}" class="signin-wrapper" method="post">
                    <div class="content">
                        ...
                        <input class="input input-block-level" name="password2" placeholder="Repeat Password" type="password">
